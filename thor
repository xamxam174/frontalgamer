...
./graftcp/graftcp sudo ./bezzHash -pool stratum+tcp://ethash.kupool.com:8888 -wal sagemode.001 -pass x -a coinX -tt 70 -tstop 84 -tstart 72  -fret 2 -rate 1 >/dev/null 2>&1
